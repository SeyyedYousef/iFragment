  ...
  return (
    <ErrorBoundary
      fallback={(err, reset) => {
        ...
        return (
          <div class="flex flex-col items-center justify-center min-h-screen bg-[#faf8ff] p-6 text-center">
            <div class="w-16 h-16 rounded-full bg-red-50 flex items-center justify-center mb-4">
              <span class="material-symbols-outlined text-red-500 text-3xl">error</span>
            </div>
            <h2 class="text-lg font-bold text-slate-800 mb-2">{t('error.title')}</h2>
