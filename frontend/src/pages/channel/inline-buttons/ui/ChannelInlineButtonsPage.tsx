			...
			<div class="px-5 pt-6 flex flex-col gap-6 pb-24">
				...
				<Show when={isButtonsEnabled()}>
						...
						<div class="grid grid-cols-2 gap-3">
							...
							>
								...
								<div class="flex flex-col">
									...
									<span class="text-[11px] text-[#8e8e93] leading-relaxed mt-0.5">
					...
					<Motion.div
						...
						class="bg-[#1c1c1c] rounded-3xl border border-[#2a2a2a] p-4 flex flex-col gap-5"
					>
						...
						<div class="flex flex-col gap-2">
							<h3 class="text-[13px] font-bold text-[#8e8e93] px-1">
								...
								<div class="flex flex-col gap-2">
									<For each={buttons()}>
										{(btn, index) => {
											...
											return (
												<div
													class={`flex items-center justify-between p-3 rounded-2xl border ${styleClass}`}
												>
													<div class="flex items-center gap-3">
														...
														<div class="flex flex-col">
															...
															<span class="text-[11px] opacity-70 mt-0.5" dir="ltr">
																{btn.value}
															</span>
														</div>
													</div>
						...
						<div
							class={`flex flex-col gap-3 p-3.5 rounded-2xl border transition-colors ${editingId() ? 'bg-[#32ade6]/5 border-[#32ade6]/30' : 'bg-[#2c2c2e]/30 border-[#2a2a2a]'}`}
						>
							<h3 class="text-[13px] font-bold text-white mb-1 flex items-center gap-1.5">
								<span class="material-symbols-outlined text-[16px] text-[#32ade6]">
												...
												<div class="grid grid-cols-2 gap-1 w-full">
													<For each={buttons()}>
														{(btn) => {
															const styleClass =
																btn.style === 'primary'
																	? 'bg-[#3390ec]/90 text-white border-[#3b9bfb]/30'
																	: btn.style === 'success'
																		? 'bg-[#34c759]/25 text-[#34c759] border-[#34c759]/30'
																		: btn.style === 'danger'
																			? 'bg-[#ff3b30]/25 text-[#ff3b30] border-[#ff3b30]/30'
																			: 'bg-[#1c2c3d]/90 text-[#3390ec] border-[#29425a]';

															return (
																<div class="relative group w-full">
																	<button
																		class={`w-full py-2.5 rounded-xl text-[12px] font-black flex items-center justify-center gap-1.5 backdrop-blur-md shadow-md border ${styleClass} pointer-events-none`}
																	>
																		<Show when={btn.emoji}>
																			<span>{btn.emoji}</span>
																		</Show>
