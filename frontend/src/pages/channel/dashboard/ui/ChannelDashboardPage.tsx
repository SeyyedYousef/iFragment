      ...
      <div class="px-5 pt-6 pb-4 flex items-center justify-between relative z-30 bg-[#0f1014] sticky top-0 border-b border-[#1c1c1c]">
        ...
        <div class="relative">
          ...
          <Show when={showTooltip()}>
            ...
            >
              <div class={`absolute -top-2 w-4 h-4 bg-[#32ade6] rotate-45 rounded-sm ${isRtl() ? 'left-4' : 'right-4'}`}></div>
      ...
      <div class="px-5 pt-6 flex flex-col gap-6">
        ...
        <Motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.02 }}>
          <div class="grid grid-cols-3 gap-3">
            ...
            >
              ...
              <span class="text-[11px] font-bold text-white text-center">{t('channelDashboard.newPost')}</span>
            </button>
            <button 
            ...
            >
              ...
              <span class="text-[11px] font-bold text-white text-center">{t('channelDashboard.manageSettings')}</span>
            </button>
            <button 
            ...
            >
              ...
              <span class="text-[11px] font-bold text-white text-center">{t('channelMenu.admins')}</span>
            </button>
          </div>
        </Motion.div>
        ...
        >
          <h2 class="text-[15px] font-bold text-white px-1 flex items-center gap-2">
            <span class="material-symbols-outlined text-[#ff9f0a] text-[18px]">local_fire_department</span>
              ...
              {(post, i) => (
                <div class={`flex items-center justify-between p-4 ${i() !== (analytics()?.summary?.top_posts?.length || 0) - 1 ? 'border-b border-[#2a2a2a]' : ''}`}>
                  <div class="flex items-center gap-3">
                    ...
                    <span class="text-[14px] font-bold text-white truncate max-w-[150px]">{post.title}</span>
                  </div>
