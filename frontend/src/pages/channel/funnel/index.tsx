			...
			<div class="px-5 pt-6 pb-4 flex items-center justify-between sticky top-0 bg-[#0f1014] z-30 border-b border-[#1c1c1c]">
				<div class="flex items-center gap-3">
					...
					<div class="flex flex-col">
						<h1 class="text-[16px] font-bold">Funnel / Approvals</h1>
						<span class="text-[11px] text-[#8e8e93]">Review posts before publishing</span>
					</div>
				</div>
				<button
					onClick={() => {
				...
				<Motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
					<div class="bg-[#1c1c1c] border border-[#2a2a2a] rounded-2xl p-5 flex flex-col gap-4">
						<div class="flex items-center gap-3">
							...
							<div class="flex flex-col">
								<h2 class="text-[15px] font-bold text-white">Publishing Funnel</h2>
								<span class="text-[12px] text-[#8e8e93]">
									Route raw posts from a hidden channel to your review panel.
								</span>
							</div>
						</div>
							...
							fallback={
								<div class="flex flex-col gap-4 mt-2">
									<div class="bg-[#34c759]/10 border border-[#34c759]/30 rounded-xl p-3 flex flex-col gap-1">
										<span class="text-[13px] font-bold text-[#34c759]">Active</span>
										<span class="text-[11px] text-white/70">
											Posts sent to your input channel are being intercepted and routed to your DM for approval.
										</span>
									</div>
									<button
						...
						>
							<div class="flex flex-col gap-3 mt-2">
								<label class="text-[12px] font-bold text-[#8e8e93]">Select Input Channel (Raw Posts)</label>
								<div class="relative">
									<select
