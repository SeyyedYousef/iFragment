		...
		async (channelId) => {
			try {
				...
				const merged: ChannelConfig = {
					...
					channelPhotoUrl: apiGeneral.photo || (apiGeneral as any).channelPhotoUrl || defaultConfig.channelPhotoUrl,
					channelUsername: apiGeneral.username || (apiGeneral as any).channelUsername || defaultConfig.channelUsername,
					...
					approveAccountAge: (apiGeneral.joinReqAge ?? 0) > 0 || (apiGeneral as any).approveAccountAge || defaultConfig.approveAccountAge,
					approveProfilePhoto: apiGeneral.joinReqPhoto ?? (apiGeneral as any).approveProfilePhoto ?? defaultConfig.approveProfilePhoto,
