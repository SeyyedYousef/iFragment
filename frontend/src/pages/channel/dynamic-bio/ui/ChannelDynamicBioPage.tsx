    ...
    <div class="min-h-screen bg-[#0f1014] pb-28 relative overflow-x-hidden text-white">
      ...
      <div class="px-5 pt-6 pb-4 bg-[#0f1014] sticky top-0 z-30 border-b border-[#1c1c1c] flex items-center justify-between">
        <div class="flex flex-col">
          <h1 class="text-[20px] font-black text-white leading-tight">{t('channelDynamicBio.title') || 'Dynamic Bio & Name'}</h1>
          <span class="text-[12px] text-on-surface-variant">{t('channelDynamicBio.subtitle') || 'Live updating channel description'}</span>
        </div>
