    ...
    <div class="min-h-screen bg-[#0a0b0e] text-white p-6 pb-32 safe-area-bottom font-sans">
      ...
      >
        ...
        <div class="grid grid-cols-2 gap-3 mb-4">
          ...
          {/* Market Cap */}
          <div 
            class="bg-[#141518] border border-[#2a2a2a] p-5 rounded-3xl col-span-2 relative overflow-hidden active:scale-[0.99] transition-transform"
            role="region"
          ...
          {/* Floor Price */}
          <div 
            class="bg-[#141518] border border-[#2a2a2a] p-4 rounded-2xl active:scale-[0.98] transition-transform"
            role="region"
