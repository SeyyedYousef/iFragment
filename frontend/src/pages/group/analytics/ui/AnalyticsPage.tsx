      ...
      <div class="px-5 pt-6 pb-4 sticky top-0 bg-[#0f1014]/90 backdrop-blur-md z-30 border-b border-[#1c1c1c] flex items-center justify-between gap-3">
        <div class="flex items-center gap-2 overflow-hidden flex-1">
          ...
          <div class="flex flex-col overflow-hidden">
            <h1 class="text-[18px] font-black text-white leading-tight truncate">{t('analyticsSettings.title')}</h1>
            <p class="text-[12px] text-on-surface-variant truncate">{t('analyticsSettings.subtitle')}</p>
          </div>
        </div>
        <div class="flex items-center gap-3">
          ...
          <button onClick={()=>setIsMenuOpen(true)} class="w-10 h-10 rounded-full bg-[#1c1c1c] flex items-center justify-center border border-[#2a2a2a] shrink-0">
