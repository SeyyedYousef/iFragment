...
describe('AnalyticsPage', () => {
  beforeEach(() => {
    ...
    (groupApi.getAnalytics as any).mockResolvedValue({
      summary: { total_members: 1000, members_change: 50, total_messages: 5000, messages_change_pct: 10, spam_blocked: 200, new_members: 60, members_left: 10, active_users: 150 },
