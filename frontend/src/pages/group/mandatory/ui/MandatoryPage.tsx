import { Component, createSignal, Show, onMount, onCleanup, createResource, Suspense } from 'solid-js';
        ...
        <div class="flex items-center gap-2 overflow-hidden flex-1">
          ...
          <div class="flex flex-col overflow-hidden">
            <div class="flex items-center gap-2">
              <h1 class="text-[18px] font-black text-white leading-tight truncate">{t('mandatorySettings.title')}</h1>
              <Show when={isDirty()}>
                <span class="w-2.5 h-2.5 rounded-full bg-[#ff9f0a] animate-pulse shrink-0" />
              </Show>
            </div>
            <span class="text-[12px] text-on-surface-variant truncate">{t('mandatorySettings.subtitle')}</span>
          </div>
        </div>
