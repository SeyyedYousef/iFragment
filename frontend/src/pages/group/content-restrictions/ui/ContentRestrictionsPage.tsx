				...
				<Show when={activeTab() === 'links'}>
					...
					>
						<div class="flex items-center justify-between px-1 mb-1">
							<span class="text-[12px] text-[#8e8e93] font-medium uppercase tracking-wider">
								{t('contentRestrictions.tabLinks')}
							</span>
							<button
								onClick={() => {
						...
						<div class="bg-[#1c1c1c] rounded-3xl border border-[#2a2a2a] p-4 flex flex-col gap-4">
							<div class="flex items-center gap-2">
								...
								<div class="flex flex-col">
									...
									<span class="text-[12px] text-[#8e8e93] leading-snug">
							...
							<div class="flex items-center gap-2">
								...
								<button
									...
									class="w-10 h-10 rounded-xl bg-[#3390ec] text-white flex items-center justify-center shrink-0"
								>
