...
export const ChannelHamburgerMenu: Component<ChannelHamburgerMenuProps> = (props) => {
  ...
  const menuItems = () => [
    { id: 'dashboard', icon: 'dashboard', label: t('channelMenu.dashboard'), path: `/channel/${props.channelId}` },
    { id: 'general', icon: 'settings', label: t('channelMenu.generalSettings'), path: `/channel/${props.channelId}/settings` },
    { id: 'posting', icon: 'smart_toy', label: t('channelMenu.autoPosting'), path: `/channel/${props.channelId}/posting` },
    { id: 'inline-buttons', icon: 'smart_button', label: t('channelMenu.inlineButtons'), path: `/channel/${props.channelId}/inline-buttons` },
    { id: 'forwarding', icon: 'call_split', label: t('channelMenu.autoForward'), path: `/channel/${props.channelId}/forwarding` },
    { id: 'dynamic-bio', icon: 'history_edu', label: t('channelMenu.dynamicBio'), path: `/channel/${props.channelId}/dynamic-bio` },
    { id: 'auto-responder', icon: 'quickreply', label: t('channelMenu.autoResponder'), path: `/channel/${props.channelId}/auto-responder` },
    { id: 'admins', icon: 'admin_panel_settings', label: t('channelMenu.admins'), path: `/channel/${props.channelId}/admins` },
    { id: 'analytics', icon: 'monitoring', label: t('channelMenu.analytics'), path: `/channel/${props.channelId}/analytics` },
    { id: 'audit-log', icon: 'manage_search', label: t('channelMenu.auditLog'), path: `/channel/${props.channelId}/audit-log` },
  ];
