...
export const SectionHeader: Component<SectionHeaderProps> = (props) => (
	<div class="text-center mb-6">
		<div
			...
			style={{
				background: `linear-gradient(to bottom right, ${props.gradient})`,
				'box-shadow': `0 8px 24px ${props.shadowColor}`,
			}}
		>
			<span
		...
		{props.subtitle && (
			<p class="text-on-surface-variant text-xs mt-1 max-w-[260px] mx-auto">{props.subtitle}</p>
		)}
		{props.children}
	</div>
);
