				...
				return [
					{
						...
						username: 'admin_user',
						first_name: 'Admin',
						custom_title: t('demoContent.customTitleAdmin'),
						is_owner: true,
				...
				return [
					{
						...
						channel_id: channelId,
						actor_id: 123456,
						action: t('demoContent.logForwardChanged'),
					...
					},
					{
						...
						channel_id: channelId,
						actor_id: 123456,
						action: t('demoContent.logNewPostSent'),
					...
					},
					{
						...
						channel_id: channelId,
						actor_id: 0,
						action: t('demoContent.logAutoResponderOn'),
					...
					},
					{
						...
						channel_id: channelId,
						actor_id: 789012,
						action: t('demoContent.logNewAdminAdded'),
