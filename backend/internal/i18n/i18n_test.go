...
func TestModerationAndVerificationKeysInAllLanguages(t *testing.T) {
	...
	keys := []string{
		...
		"bot.id_info",
		"templates.warning",
		"templates.force_join",
		"templates.force_add",
		"templates.silence_start",
		"templates.silence_end",
		"templates.rules_default",
		"templates.welcome_default",
		"receipts.pro_pass_title",
		"receipts.username_report_title",
		"receipts.number_report_title",
		"receipts.gift_report_title",
		"receipts.avm_access_title",
		"receipts.credit_pack_title",
		"channel.already_voted",
		"channel.click_registered",
		"channel.click_failed",
		"channel.join_request_rejected_premium",
		"channel.join_request_rejected_photo",
		"channel.join_request_rejected_account_age",
		"channel.join_request_rejected_collectibles",
		"channel.join_request_rejected_gifts",
		"verification.btn_verify",
		"funnel.btn_approve_send",
		"funnel.btn_reject",
		"funnel.btn_regenerate",
		"funnel.btn_style_variation",
		"funnel.preview_header",
		"funnel.unauthorized_action",
		"funnel.publishing_progress",
		"funnel.published_success",
		"funnel.rejected_confirm",
	}
