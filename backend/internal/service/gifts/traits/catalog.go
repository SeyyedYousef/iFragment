...
var OfficialCollections = map[string]CollectionMeta{
	...
	"desk_calendar": {
		...
		BaseStarsPrice:   4000,
		InitialFloorGRAM: 38.0,
		Description:      "157 models desktop calendar tracking milestones",
	},
	"jingle_bells": {
		...
		BaseStarsPrice:   3000,
		InitialFloorGRAM: 28.0,
		Description:      "151 models celebratory chiming holiday bells",
	},
	"santa_hat": {
		ModelID:          "santa_hat",
		Name:             "Santa Hat",
		...
		BaseStarsPrice:   2000,
		InitialFloorGRAM: 18.0,
		Description:      "Iconic crimson holiday cap with velvet trim",
	},
	"liberty_figure": {
		...
		Description:      "Statue of Liberty statuette with blazing torch",
	},
	"fine_pen": {
		ModelID:          "fine_pen",
		Name:             "Fine Pen",
	...
	"chill_flame": {
		...
		CraftedFlag:      false,
		BaseStarsPrice:   5500,
		InitialFloorGRAM: 52.0,
		Description:      "Stylized eternal flame with tranquil aura",
	},
	"timeless_book": {
		...
		CraftedFlag:      false,
		BaseStarsPrice:   4500,
		InitialFloorGRAM: 44.0,
		Description:      "Leather-bound tome containing ancient wisdom",
	},
	"vice_cream": {
		ModelID:          "vice_cream",
		Name:             "Vice Cream",
		...
		BaseStarsPrice:   3200,
		InitialFloorGRAM: 30.0,
		Description:      "Gourmet triple-scoop sundae with sprinkles",
	},
	"surge_board": {
		ModelID:          "surge_board",
		Name:             "Surge Board",
		...
		CraftedFlag:      false,
		BaseStarsPrice:   8000,
		InitialFloorGRAM: 78.0,
		Description:      "Aerodynamic hydrofoil surfboard in carbon fiber",
	},
	"durov_glasses": {
		ModelID:          "durov_glasses",
		Name:             "Durov's Glasses",
		TotalSupply:      5000,
		CraftedFlag:      false,
		BaseStarsPrice:   15000,
		InitialFloorGRAM: 145.0,
		Description:      "Signature sunglasses worn by Pavel Durov",
	},
	"scared_cat": {
		ModelID:          "scared_cat",
		Name:             "Scared Cat",
		...
		BaseStarsPrice:   5000,
		InitialFloorGRAM: 48.0,
		Description:      "Wide-eyed animated kitten with expressive reactions",
	},
	"signet_ring": {
		ModelID:          "signet_ring",
		Name:             "Signet Ring",
		...
		CraftedFlag:      false,
		BaseStarsPrice:   7500,
		InitialFloorGRAM: 72.0,
		Description:      "Heavy engraved sovereign gold seal signet ring",
	},
}
